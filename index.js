  ...
  bot.on('interactionCreate', async interaction => {
    try {
      ...
      // Interação com os botões de julgamento
        ...
        if (!punishment) return interaction.reply({ content: 'Castigo não encontrado no banco de dados.', ephemeral: true });
        ...
        await interaction.reply(`O usuário <@${userId}> foi perdoado. Este canal será deletado em 5 segundos.`);
        ...
        await interaction.reply(`O castigo de <@${userId}> foi confirmado (24h). O membro não poderá interagir no servidor. Este canal será deletado em 10 segundos.`);
